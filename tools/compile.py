...
Focus on extracting knowledge, not just summarizing. Each language section should be substantive, not a mere translation."""
        ...
        type_to_plugin = {
            ...
            "ethdocs": "ethdocs", "eip": "eips",
            "defillama_protocol": "defillama", "defillama_chain": "defillama",
            "defillama_category": "defillama",
            "l2beat": "l2beat", "rekt": "rekt",
            "spellbook_protocol": "spellbook",
        ...
        for key in ("work_id", "canon", "work", "chapter", "book",
                    "eip_number", "protocol", "chain", "l2_name", "section", "concept"):
